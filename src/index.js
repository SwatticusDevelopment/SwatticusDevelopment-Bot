...
axios.get('https://api.github.com/repos/SwatticusDevelopment/SwatticusDevelopment-Bot/releases/latest').then(res => {
...
console.log(`\u001b[0m`)
console.log(chalk.red(`© SwatticusDevelopment | 2023 - ${new Date().getFullYear()}`))
